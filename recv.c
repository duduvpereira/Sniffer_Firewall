...
int main(int argc,char *argv[])
{
  ...
  //destAddr.sll_ifindex = ifr.ifr_ifindex;  /* indice da interface pela qual os pacotes serao enviados. Eh necess�rio conferir este valor. */
...
int t;
    ...
    if((buff1[12]==8)&&(buff1[13]==0)){
      ...
      p=(buff1[36]<<8)+(buff1[37]);
      printf("Porta Destino:  %d \n\n", p);
      //if((buff1[26] != 0x0a)&&(buff1[27] != 0x00)&&(buff1[28] != 0x00)&&
      //(buff1[29] != 0x14)){
        printf("Entrei\n");
        buff1[0] = 0x00;
        buff1[1] = 0x00;
